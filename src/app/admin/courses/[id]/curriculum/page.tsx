...
import {
  ...
  ArrowLeft, Loader2, GripVertical, Check, Eye
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8fafc] p-6 lg:p-10 pb-32">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div className="flex items-center gap-6">
          <button
            onClick={() => router.back()}
            className="h-12 w-12 rounded-full bg-white border border-slate-100 flex items-center justify-center text-slate-400 hover:text-slate-900 transition-all shadow-sm"
          >
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all">
                        {lesson.videoUrl ? (
                          <a
                            ...
                            className="h-8 w-8 rounded-full flex items-center justify-center hover:bg-blue-50 hover:text-blue-500 text-slate-400 transition-all"
                          ...
                          <button
                            className="h-8 w-8 rounded-full flex items-center justify-center text-slate-200 cursor-default"
                            disabled
                          >
                            <Eye className="h-3.5 w-3.5" />
                          </button>
